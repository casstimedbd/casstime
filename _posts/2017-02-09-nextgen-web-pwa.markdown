...
> 本文首发于 [CSDN](http://geek.csdn.net/news/detail/135595) 与《程序员》2017 年 2 月刊，同步发布于 [DBD Community](https://casstimedbd.github.io)、[前端外刊评论 - 知乎专栏](https://zhuanlan.zhihu.com/FrontendMagazine)，转载请保留链接 ;)
...
图中从左到右分别为：类似原生应用的安装界面；被收纳在应用抽屉里的 Flipkart Lite 与 DBD Community；设置界面中并列出现的 Flipkart 原生应用与 Flipkart Lite PWA （可以看到 PWA 巨大的体积优势）
...
- `start_url`：定义了一个 PWA 的入口页面。比如说你添加 [DBD Community][21] 的任何一个文章到主屏，从主屏打开时都会访问 [DBD Community][21] 的主页。
...
你也可以尝试在支持 PWA 的浏览器中访问笔者的博客 [DBD Community][21]，感受 Service Worker 的实际效果：所有访问过的页面都会被缓存并允许在离线环境下继续访问，所有未访问过的页面则会在离线环境下展示一个自定义的离线页面。
...
[21]: https://casstimedbd.github.io "DBD Community"
...
[q37]: https://casstimedbd.github.io/pwa-qcon2016/#/37 "PWA@QCon2016 #37"

[q17]: https://casstimedbd.github.io/pwa-qcon2016/#/17 "PWA@QCon2016 #17"

[q97]: https://casstimedbd.github.io/pwa-qcon2016/#/99 "PWA@QCon2016 #97"

[s12]: https://casstimedbd.github.io/sw-101-gdgdf/#/12 "SW-101@DevFest #12"

[s13]: https://casstimedbd.github.io/sw-101-gdgdf/#/13 "SW-101@DevFest #13"

[b0]: https://casstimedbd.github.io/2016/11/20/sw-101-gdgdf/
